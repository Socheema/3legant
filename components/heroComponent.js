    ...
    <Image src="/Slider.png" fill  className='hidden md:block object-cover'/>
       ...
       <div className='flex flex-col md:flex-row items-start gap-4 justify-between'>
         <h1 className='text-[#141718] text-2xl md:text-4xl lg:text-6xl '>
          Simply Unique <span className='text-[#6C7275] font-extrabold'>|</span> 
          <br/>
           Simply better <span className='text-[#6C7275] font-extrabold'>.</span>
        </h1>
        <p className='text-[#6C7275] md:self-center'><span className='text-[#343839]'>3legant</span> is a gift and decoration store based in HcMC, <br/> Vietnam. Est since 2019</p>
       </div>
      </div>
