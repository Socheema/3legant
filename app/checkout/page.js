      ...
      <div className="pt-6 pb-10 gap-10 flex flex-col w-full px-8 md:px-25 items-center">
        ...
        <div className="flex flex-col md:flex-row w-full gap-6">
          ...
          "
            ...
            <Link href="/payment">
              {" "}
              <button className="hidden md:flex items-center justify-center rounded-md px-4 py-3 cursor-pointer bg-black text-white w-full">
                Place Order
              </button>
            </Link>
          </div>
          ...
          <div className="w-full  flex flex-col gap-3 border border-neutral-03 p-4 rounded-md flex-1 max-h-max">
            ...
            <div className="">
              ...
              <div className="flex w-full items-center justify-between gap-4">
                <div className="flex border border-neutral-03 rounded-md px-4 py-3 flex-3">
                  <input
                    type="text"
                    placeholder="Input"
                ...
                <button className="flex flex-1 items-center rounded-md px-4 py-3 cursor-pointer bg-black text-white ">
                  Apply
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 mt-4">
              ...
              <div className="flex justify-between py-2 border-b border-[#E8ECEF]">
                ...
                <p className="text-neutral-07">${getTotal.toFixed(2)}</p>
              </div>
        ...
        <Link href="/payment" className="cursor-pointer w-full">
          <button className="flex md:hidden items-center justify-center rounded-md px-4 py-3 cursor-pointer bg-black text-white w-full">
            Place Order
          </button>
        </Link>
      </div>
